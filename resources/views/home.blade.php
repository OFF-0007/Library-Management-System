...
<div class="sidebar">
  ...
  <a href="{{ url('student/add')}}"><i class="fa fa-fw fa-wrench"></i>Students</a>
  <a href="{{url('publisher/add')}}"><i class="fa fa-fw fa-user"></i>Publishers</a>
  <a href="{{url('book/add')}}"><i class="fa fa-fw fa-envelope"></i>Books</a>
  <a href="{{url('author/add')}}"><i class="fa fa-fw fa-envelope"></i>Authors</a>
